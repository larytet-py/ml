...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-parquet", default="data/bayesian/option_strategy_features.parquet")
    parser.add_argument("--schema-json", default="data/bayesian/option_strategy_features.schema.json")
    parser.add_argument("--meta-json", default="data/bayesian/option_strategy_features.meta.json")
